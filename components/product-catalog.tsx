...
import { Search, DollarSign, Package, ChevronLeft, ChevronRight, ShoppingCart } from "lucide-react"
...
export function ProductCatalog() {
  ...
  return (
    <div className="min-h-screen bg-background">
      {/* Header */}
      <header className="border-b sticky top-0 z-50 backdrop-blur-lg bg-card/80 border shadow">
        <div className="container mx-auto px-4 py-6">
          <div className="flex items-center justify-between mb-4">
            <div>
              <h1 className="text-3xl font-bold text-foreground mb-1">
                <Image src={logoSrc} alt="Logo" className="w-32 inline-block mr-2 mb-1" />
                Catálogo de Productos
                </h1>
              <p className="text-muted-foreground">Informática GA - Paraguay</p>
            </div>
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="flex flex-col lg:flex-row gap-6">
          {/* Sidebar - Categories */}
          <aside className="lg:w-64 flex-shrink-0 lg:sticky lg:top-24 lg:h-[calc(100vh-7rem)]">
            ...
            {isLoading ? (
              ...
              <Card>
                <CardContent className="pt-6 text-center py-12">
                  ...
                  <p className="text-sm text-muted-foreground mt-2">Intenta con otros términos de búsqueda o filtros</p>
                </CardContent>
              </Card>
            ) : (
              <>
